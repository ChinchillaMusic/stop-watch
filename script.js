...
var StopWatch = function (_React$Component) {
  ...
  _createClass(StopWatch, [{
    ...
    value: function start() {
      ...
      if (!this.timer) {
        var startTime = Date.now() - this.state.timePassedInMilliSeconds;
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "button",
            { className: "btn btn-outline-primary me-2", onClick: this.start },
            "start"
          ),
          React.createElement(
            "button",
            { className: "btn btn-outline-danger me-2", onClick: this.stop },
            "stop"
          ),
          React.createElement(
            "button",
